...
public class Mesa implements Cloneable {
	...
	public static final String COLOR_NAME_DEFAULT = "#ffffff";
	...
	public static String getColorNameDefault() {
		return COLOR_NAME_DEFAULT;
	}
	...
	public int getPrecio() {
		...
		if (!COLOR_NAME_DEFAULT.equalsIgnoreCase(this.color)) {
